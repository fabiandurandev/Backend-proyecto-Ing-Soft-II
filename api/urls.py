...
urlpatterns = [
    ...
    path('empleado/<int:cedulaEmpleado>', views.EmpleadoRetrieveUpdateDestroyAPIView.as_view()),
    ...
    path('proveedor/<int:rifProveedor>', views.ProveedorRetrieveUpdateDestroyAPIView.as_view()),
